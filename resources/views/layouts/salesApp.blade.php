                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li class="nav-item">
                        <a href="{{route('sales.create_ticket')}}" class="nav-link align-middle px-0">
                            <i class="bi bi-ticket"></i> <span class="ms-1 d-none d-sm-inline">Create Ticket</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('sales.follow_ticket')}}" class="nav-link align-middle px-0">
                            <i class="bi bi-ticket"></i> <span class="ms-1 d-none d-sm-inline">Follow Ticket</span>
                        </a>
                    </li>
